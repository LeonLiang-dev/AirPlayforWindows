...
ENDPOINT_MINIPAIR SpeakerMiniports =
{
    ...
    NULL,                                                   // optional template name
    CreateMiniportWaveRTSYSVAD,
    &AirPlayFlowWaveMiniportFilterDescriptor,
    ...
    AirPlayFlowPinDeviceFormatsAndModes,
    SIZEOF_ARRAY(AirPlayFlowPinDeviceFormatsAndModes),
